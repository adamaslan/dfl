  ...
  return (
    <>
      ...
      <div className={styles.gridcontainer4}>
        ...
        <p>By Adam Aslan</p>
        <p>
        ZXY Gallery and Drinks Food Life teamed up for an art pop-up that featured an Amaro Montenegro tasting on the rooftop of ZXY Gallery in Bushwick. The event transformed the gallery's rooftop into an ideal place for tasting an exceptional amaro. Local artists showcased their work, while guests sipped on expertly crafted cocktails featuring Amaro Montenegro, a versatile Italian herbal liqueur known internationally. The rest was history. Insert upside-down smiley face here.</p> <p> The event embodied the Drinks Food Life spirit - where a love for good food, drinks, and art comes together to create unique experiences transcending the typical atmosphere one usually encounters with cocktails and culture.
        </p>
        <p>
        ZXY Gallery is located by the Williamsburg and Bushwick border. Drinks Food Life is a publication that curates events and publishes articles focused on cultural experiences, drinks, food, and life.
        </p>
        <p>
          Check out the ZXY Gallery instagram for more info <a href="https://www.instagram.com/zxygallery/"><u>here</u></a>
        </p>
