    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.smain}>
          ...
          <div className={styles.divArt}>
            {" "}
            <h1> On the love of Art and Fish </h1> <h2> The Story of Nicole Burko</h2>{" "}
          </div>
        </div>{" "}
        <div className={styles.smain3}>
          <p>
          Nicole Burko graduated with her MFA in painting from Columbia. In the years that followed she went on to become a renowned spear fisher. This food is from a fish she caught. Check out her instagram @nicoleburko {" "}
          </p>{" "}
        </div>{" "}
      </div>{" "}
